...
$$.Ball = {"":
 ["color", "speed", "radius", "size?"],
 super: "Object",
 updatePosition$1: function(time) {
  if (typeof time !== 'number') return this.updatePosition$1$bailout(1, time, 0, 0, 0, 0);
  var t1 = this.speed;
  if (typeof t1 !== 'number') return this.updatePosition$1$bailout(2, time, t1, 0, 0, 0);
  var degree = time * t1 / 1000;
  $.ctx2d.beginPath$0();
  var t2 = this.color;
  $.ctx2d.set$fillStyle(t2);
  t2 = $.ctx2d;
  var t3 = $.canvas.get$width();
  if (t3 !== (t3 | 0)) return this.updatePosition$1$bailout(3, t3, degree, t2, 0, 0);
  t3 = $.shr(t3, 1);
  var t4 = this.radius;
  if (typeof t4 !== 'number') return this.updatePosition$1$bailout(4, degree, t3, t2, t4, 0);
  var t5 = $.Math_sin(degree);
  if (typeof t5 !== 'number') return this.updatePosition$1$bailout(5, degree, t2, t3, t5, t4);
  t3 += t4 * t5;
  var t6 = $.canvas.get$height();
  if (t6 !== (t6 | 0)) return this.updatePosition$1$bailout(6, degree, t3, t6, t2, t4);
  t6 = $.shr(t6, 1);
  var t7 = $.Math_cos(degree);
  if (typeof t7 !== 'number') return this.updatePosition$1$bailout(7, t7, t3, t6, t2, t4);
  t2.arc$6(t3, t6 + t4 * t7, this.size, 0, 6.283185307179586, true);
  $.ctx2d.closePath$0();
  $.ctx2d.fill$0();
 },
 updatePosition$1$bailout: function(state, env0, env1, env2, env3, env4) {
  switch (state) {
    case 1:
      var time = env0;
      break;
  ...
  switch (state) {
    ...
    case 2:
      state = 0;
      var degree = $.div($.mul(time, t1), 1000);
      $.ctx2d.beginPath$0();
      var t2 = this.color;
      $.ctx2d.set$fillStyle(t2);
      t2 = $.ctx2d;
    ...
    case 7:
      state = 0;
      t2.arc$6(t3, $.add(t6, $.mul(t4, t7)), this.size, 0, 6.283185307179586, true);
      $.ctx2d.closePath$0();
      $.ctx2d.fill$0();
  }
 }
...
$$.CanvasCircle = {"":
 ["balls?", "_container", "_dlgInfos", "_mainView", "_title"],
 super: "Activity",
 onCreate_$0: function() {
  this.set$title('Circles');
  $.canvas = $.Canvas$();
  $.canvas.get$profile().set$text('anchor: parent; width: flex; height: flex');
  this.get$mainView().addChild$1($.canvas);
  this.balls = [$.Ball$(50, 2.0, 6, 'red'), $.Ball$(30, 1.3, 6, 'blue'), $.Ball$(70, 1.6, 10, 'green'), $.Ball$(100, 1.0, 13, 'yellow'), $.Ball$(130, 0.8, 8, '#0ff')];
  $.ctx2d = $.canvas.get$context2D();
  $._Animator$().add$1(new $.CanvasCircle_onCreate__anon(this));
 }
};
...
$$.FilteredElementList = {"":
 ...
 set$length: function(newLength) {
  ...
  if ($.ltB(newLength, 0)) throw $.captureStackTrace($.CTC48);
...
$$.View = {"":
 ["_dataAttrs!", "_childInfo?", "_virtIS=", "_prevSibling=", "_nextSibling=", "_lib2_parent!", "_id?"],
 super: "Object",
 toString$0: function() {
...
$$._SubviewList = {"":
 ...
 operator$indexSet$2: function(index, value) {
  if (value == null) throw $.captureStackTrace($.CTC51);
...
$$.Canvas = {"":
 ...
 domAttrs_$4: function(out, noId, noStyle, noClass) {
  !(this.get$width() == null) && $.add$1($.add$1($.add$1(out, '  width="'), this.get$width()), '"');
  !(this.get$height() == null) && $.add$1($.add$1($.add$1(out, '  height="'), this.get$height()), '"');
...
$$.CanvasCircle_onCreate__anon = {"":
 ["this_0"],
 super: "Closure",
 $call$2: function(time, elapsed) {
  $.ctx2d.clearRect$4(0, 0, $.canvas.get$width(), $.canvas.get$height());
  for (var t1 = $.iterator(this.this_0.get$balls()); t1.hasNext$0() === true; ) {
    t1.next$0().updatePosition$1(time);
  }
  return true;
 }
};
...
$$._NativeJsSendPort_send_anon = {"":
 ...
 $call$0: function() {
  ...
  if (isolate == null) return;
  if (this.this_4.get$_receivePort().get$_lib7_callback() == null) return;
...
$$._NativeJsSendPort_send_anon0 = {"":
 ...
 super: "Closure",
 $call$0: function() {
  if (!(this.this_7.get$_receivePort().get$_lib7_callback() == null)) {
...
$.StringUtil_encodeXML = function(txt, multiline, maxlength, pre) {
  ...
  if (multiline || t1) {
    ...
    for (enc = null, j = 0, k = 0; j < tl; ++j) {
      t1 = txt.length;
      if (j < 0 || j >= t1) throw $.ioore(j);
      enc = $.CTC45.operator$index$1(txt[j]);
      if (!(enc == null)) {
        $.add$1($.add$1($.add$1(out.add$1($.substring$2(txt, k, j)), '&'), enc), ';');
        k0 = j + 1;
        k = k0;
...
$.AnchorRelation_position = function(view, x, y, location$) {
  if (location$ == null || $.isEmpty(location$) === true) {
    ...
    $.index($._anchorXHandlers(), $.index(handlers, 0)).$call$3(x, $.CTC59, view);
    $.index($._anchorYHandlers(), $.index(handlers, 1)).$call$3(y, $.CTC59, view);
  }
};
...
$.Ball$ = function(radius, speed, size, color) {
  return new $.Ball(color, speed, radius, size);
};
...
$.CanvasCircle$ = function() {
  var t1 = new $.CanvasCircle(null, null, [], null, '');
  t1.Activity$0();
  return t1;
};
    ...
    case 2:
      if (state == 2 || (state == 0 && (multiline || t1))) {
        ...
        for (enc = null, j = 0, k = 0; $.ltB(j, tl); ++j) {
          enc = $.CTC45.operator$index$1($.index(txt, j));
          if (!(enc == null)) {
            $.add$1($.add$1($.add$1(out.add$1($.substring$2(txt, k, j)), '&'), enc), ';');
            k0 = j + 1;
            k = k0;
...
$.CTC45 = new Isolate.$isolateProperties.ConstantMap(Isolate.$isolateProperties.CTC44, {'<': 'lt', '>': 'gt', '&': 'amp', '"': 'quot'}, 4);
...
$.CTC46 = new Isolate.$isolateProperties.UnsupportedOperationException('');
$.CTC41 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '(mozilla)(?:.*? rv:([\\w.]+))?');
$.CTC47 = new Isolate.$isolateProperties.NotImplementedException(null);
$.CTC40 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '(msie) ([\\w.]+)');
$.CTC32 = new Isolate.$isolateProperties._AnchorOfRoot();
$.CTC59 = new Isolate.$isolateProperties._AnchorOfPoint();
$.CTC49 = new Isolate.$isolateProperties.UnsupportedOperationException('Not IdSpace');
...
$.CTC48 = new Isolate.$isolateProperties.IllegalArgumentException('Invalid list length');
...
$.CTC51 = new Isolate.$isolateProperties.IllegalArgumentException('null');
$.CTC50 = new Isolate.$isolateProperties.UnsupportedOperationException('Cannot modify');
...
$.$defineNativeClass('HTMLImageElement', ["width=", "name=", "height=", "align?"], {
