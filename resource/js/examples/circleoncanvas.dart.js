...
$$.JSInvocationMirror = {"": ["memberName>", "_internalName", "_kind", "_liblib1$_arguments", "_namedArgumentNames", "_namedIndices"],
 "super": "Object",
...
$$.Object = {
 ...
 call$1$layout: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("call", "call$1$layout",0, [$0], ["layout"]));
 },
 ...
 updatePosition$1: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("updatePosition", "updatePosition$1",0, [$0], []));
 },
 ...
 get$_liblib$_view: function() {
  return this.noSuchMethod$1($.createInvocationMirror("_view", "_liblib$_view$0",1, [], []));
 },
 ...
 get$_liblib$_top: function() {
  return this.noSuchMethod$1($.createInvocationMirror("_top", "_liblib$_top$0",1, [], []));
 },
 get$pageX: function() {
 ...
 get$_liblib3$_tasks: function() {
  return this.noSuchMethod$1($.createInvocationMirror("_tasks", "_liblib3$_tasks$0",1, [], []));
 },
 ...
 get$_liblib5$_ptr: function() {
  return this.noSuchMethod$1($.createInvocationMirror("_ptr", "_liblib5$_ptr$0",1, [], []));
 },
 ...
 get$balls: function() {
  return this.noSuchMethod$1($.createInvocationMirror("balls", "balls$0",1, [], []));
 },
 ...
 set$_liblib4$_dataAttrs: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("_dataAttrs=", "_liblib4$_dataAttrs=$1",2, [$0], []));
 },
...
$$.Ball = {"": ["size>", "radius", "speed", "color"],
 "super": "Object",
 updatePosition$1: function(time) {
  var degree, t1, t2, t4, t5;
  if (typeof time !== 'number')
    return this.updatePosition$1$bailout(1, time);
  degree = time * this.speed / 1000;
  $.ctx2d.beginPath$0();
  t1 = this.color;
  t2 = $.ctx2d;
  t2.set$fillStyle(t1);
  t1 = $.canvas.get$width();
  if (t1 !== (t1 | 0))
    return this.updatePosition$1$bailout(2, t1, degree, t2);
  t1 = $.shr(t1, 1);
  t4 = this.radius;
  t1 += t4 * $.sin(degree);
  t5 = $.canvas.get$height();
  if (t5 !== (t5 | 0))
    return this.updatePosition$1$bailout(3, degree, t1, t2, t5, t4);
  t2.arc$6(t1, $.shr(t5, 1) + t4 * $.cos(degree), this.size, 0, 6.283185307179586, true);
  $.ctx2d.closePath$0();
  $.ctx2d.fill$0();
},
 updatePosition$1$bailout: function(state0, env0, env1, env2, env3, env4) {
  switch (state0) {
    case 1:
      time = env0;
      break;
  ...
  switch (state0) {
    ...
    case 1:
      state0 = 0;
      degree = $.div($.mul(time, this.speed), 1000);
      $.ctx2d.beginPath$0();
      t1 = this.color;
      t2 = $.ctx2d;
      t2.set$fillStyle(t1);
    ...
    case 2:
      ...
      t1 = $.shr(t1, 1);
      t4 = this.radius;
      t1 = $.add(t1, t4 * $.sin(degree));
      t5 = $.canvas.get$height();
    case 3:
      var time, degree, t1, t2, t4, t5;
      state0 = 0;
      t2.arc$6(t1, $.add($.shr(t5, 1), t4 * $.cos(degree)), this.size, 0, 6.283185307179586, true);
      $.ctx2d.closePath$0();
      $.ctx2d.fill$0();
  }
}
...
$$.CanvasCircle = {"": ["balls>"],
 ...
 run$0: function() {
  var t1 = $.Canvas$();
  t1.addToDocument$1$layout(true);
  $.canvas = t1;
  this.balls = [$.Ball$(50, 2, 6, "red"), $.Ball$(30, 1.3, 6, "blue"), $.Ball$(70, 1.6, 10, "green"), $.Ball$(100, 1, 13, "yellow"), $.Ball$(130, 0.8, 8, "#0ff")];
  $.ctx2d = $.canvas.get$context2D();
  t1 = $.Animator_Animator();
  $.getInterceptor(t1).add$1(t1, new $.CanvasCircle_run_anon(this));
}
};
...
$$._ReceivePortImpl = {"": ["_id>", "_liblib8$_callback>"],
 "super": "Object",
 _liblib8$_callback$2: function(arg0, arg1) { return this._liblib8$_callback.call$2(arg0, arg1); },
...
$$._OnDemandMap = {"": ["_creator", "_map"],
 ...
 get$keys: function() {
  var t1 = this._map;
  return !(t1 == null) ? t1.get$keys() : $.CTC15;
},
 get$values: function() {
  var t1 = this._map;
  return !(t1 == null) ? t1.get$values() : $.CTC15;
},
 get$isEmpty: function() {
  var t1 = this._map;
...
$$.View = {"": ["_parent=", "_nextSibling=", "_prevSibling=", "_virtIS=", "_dataAttrs<", "_top>"],
 "super": "Object",
 get$className: function() {
 ...
 addToDocument$1$layout: function(layout) {
  return this.addToDocument$3$layout$mode$ref(layout,null,null)
},
 _removeFromDocument$0: function() {
  var dlgInfo, t1, t2;
  this._unmount$0();
...
$$._EventListenerInfo = {"": ["_owner", "on>", "_liblib6$_listeners", "_domListeners"],
 "super": "Object",
 ...
 add$2: function(type, listener) {
  ...
  if (listener == null)
    throw $.$$throw($.CTC26);
  if (this._liblib6$_listeners == null)
    this._liblib6$_listeners = $.makeLiteralMap([]);
  t1.first_10 = false;
  t2 = this._liblib6$_listeners.putIfAbsent$2(type, new $._EventListenerInfo_add_anon(t1));
...
$$._VirtualIdSpace = {"": ["_owner", "_fellows"],
 ...
 bindFellow_$2$bailout: function(state0, t2, id, fellow, t1) {
  if (t1)
...
$$.Canvas = {"": ["_uuid", "_parent", "_nextSibling", "_prevSibling", "_virtIS", "_childInfo", "_evlInfo", "_dataAttrs", "_mntAttrs", "_annos", "_style", "_node", "_left", "_top", "_width", "_height", "_profile", "_layout", "_inDoc"],
 "super": "View",
 get$context2D: function() {
...
$$.ViewEventListenerList = {"": ["_liblib5$_ptr>", "_type"],
 "super": "Object",
 add$1: function(handler) {
  this._liblib5$_ptr.add$2(this._type, handler);
  return this;
},
 remove$1: function(handler) {
  this._liblib5$_ptr.remove$2(this._type, handler);
  return this;
},
 get$isEmpty: function() {
...
$$.ActivateEvent = {"": ["_liblib5$_source>", "_type", "_stamp", "_propStop", "target", "currentTarget"],
 "super": "ViewEvent",
 get$source: function() {
...
$$.MeasureContext = {"": ["widths", "heights", "_borderWds", "_borderHghs", "_liblib4$_dataAttrs<"],
 "super": "Object",
 ...
 get$dataAttributes: function() {
  var t1 = this._liblib4$_dataAttrs;
  ...
  for (t1 = view.get$children(), t1 = $.getInterceptor(t1).iterator$0(t1), width = 0, prevSpacing = null; t1.get$hasNext() === true;) {
    ...
    switch (amt.type) {
      ...
      case $.CTC20:
        ...
        wd = !(wapp == null) && !$.eqB(amt.type, $.CTC20) ? wapp : t2.measureWidth_$1(mctx);
  ...
  for (t1 = view.get$children(), t1 = $.getInterceptor(t1).iterator$0(t1), height = null; t1.get$hasNext() === true;) {
    ...
    switch (amt.type) {
      ...
      case $.CTC20:
        ...
        h = !(happ == null) && !$.eqB(amt.type, $.CTC20) ? happ : t2.measureHeight_$1(mctx);
 ...
 measureHeight$2: function(mctx, view) {
  ...
  for (t1 = view.get$children(), t1 = $.getInterceptor(t1).iterator$0(t1), height = 0, prevSpacing = null; t1.get$hasNext() === true;) {
    ...
    switch (amt.type) {
      ...
      case $.CTC20:
        happ = mctx.getHeightByApp$1(t2);
        hgh = !(happ == null) && !$.eqB(amt.type, $.CTC20) ? happ : t2.measureHeight_$1(mctx);
 ...
 measureWidth$2: function(mctx, view) {
  ...
  for (t1 = view.get$children(), t1 = $.getInterceptor(t1).iterator$0(t1), width = null; t1.get$hasNext() === true;) {
    ...
    switch (amt.type) {
      ...
      case $.CTC20:
        wapp = mctx.getWidthByApp$1(t2);
        w = !(wapp == null) && !$.eqB(amt.type, $.CTC20) ? wapp : t2.measureWidth_$1(mctx);
...
$$.RunOnceQueue = {"": ["_liblib3$_tasks>"],
 "super": "Object",
 add$3: function(key, task, timeout) {
  var t1, tid;
  t1 = this._liblib3$_tasks;
  if (!(t1 == null)) {
    tid = t1.remove$1(key);
    if (!(tid == null))
      $.window().clearTimeout$1(tid);
  } else
    this._liblib3$_tasks = $.makeLiteralMap([]);
  $.indexSet(this._liblib3$_tasks, key, $.window().setTimeout$2(new $.RunOnceQueue_add_anon(task, key, this), timeout));
},
...
$$.RunOnceViewManager = {
 ...
 _ready$2: function(view, force) {
  ...
  if ($.getInterceptor(t1).get$isEmpty(t1) !== true) {
    continueTask = new $.RunOnceViewManager__ready_anon(view, this, force);
...
$$.ViewIterator = {"": ["_root", "_selectors", "_posOffset", "_allIds", "_offsetRoot", "_currCtx", "_liblib7$_ready", "_liblib7$_next=", "_liblib7$_index"],
 "super": "Object",
 _liblib7$_ready$2: function(arg0, arg1) { return this._liblib7$_ready.call$2(arg0, arg1); },
 next$0: function() {
  if (this.get$hasNext() !== true)
    throw $.$$throw($.StateError$("No more elements"));
  this._liblib7$_ready = false;
 ...
 _loadNext$0: function() {
  if (this._liblib7$_ready)
    return;
  this._liblib7$_next = this._seekNext$0();
  this._liblib7$_ready = true;
},
 _seekNext$0: function() {
...
$$.CanvasCircle_run_anon = {"": ["this_0"],
 "super": "Closure",
 call$1: function(time) {
  var t1;
  $.ctx2d.clearRect$4(0, 0, $.canvas.get$width(), $.canvas.get$height());
  for (t1 = this.this_0.get$balls(), t1 = $.getInterceptor(t1).iterator$0(t1); t1.get$hasNext() === true;)
...
$$.RunOnceQueue_add_anon = {"": ["task_2", "key_1", "this_0"],
 "super": "Closure",
 call$0: function() {
  this.this_0.get$_liblib3$_tasks().remove$1(this.key_1);
  this.task_2.call$0();
}
};
...
$$.MeasureContext_dataAttributes_anon = {"": ["this_0"],
 ...
 call$0: function() {
  var t1 = $.Map_Map();
  this.this_0.set$_liblib4$_dataAttrs(t1);
  return t1;
}
};
...
$$.ViewEventListenerMap__get_anon = {"": ["this_1", "type_0"],
 "super": "Closure",
 call$0: function() {
  return $.ViewEventListenerList$(this.this_1.get$_liblib5$_ptr(), this.type_0);
}
};
...
$$._NativeJsSendPort_send__anon = {"": ["shouldSerialize_7", "this_6", "box_0"],
 ...
 call$0: function() {
  ...
  if (!(t1.get$_receivePort().get$_liblib8$_callback() == null)) {
    ...
    t2 = this.box_0;
    t1._liblib8$_callback$2(t2.msg_1, t2.reply_2);
  }
}
};
...
$.ViewIterator__getCommonSeqLength = function(list) {
  var t1, max, strs, t2, t3, id, i, i0, t4;
  for (t1 = $.getInterceptor(list).iterator$0(list), max = 0, strs = null; t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    if (strs == null) {
...
$.Futures_wait = function(futures) {
  ...
  if ($.getInterceptor(futures).get$isEmpty(futures) === true)
    return $.Future_Future$immediate($.CTC15, 'List');
...
$.Selectors_parse = function(source) {
  var tokens, selectors, t1, currSeq, state, curr, t2, t3;
  tokens = $.Selectors_tokenize(source);
  selectors = $.List_List(null, 'Selector');
  $.setRuntimeTypeInfo(selectors, ['Selector']);
  for (t1 = $.getInterceptor(tokens).iterator$0(tokens), currSeq = null, state = 1, curr = null; t1.get$hasNext() === true;) {
    t2 = t1.next$0();
...
$._getAmountInfo = function(view, value) {
  ...
  if ($.eqB(amt.type, $.CTC19) && view.get$layout().get$handler().get$isFlex() === true) {
    amt.type = $.CTC21;
    amt.value = 1;
  }
  return amt;
...
$._getLocators = function(loc) {
  ...
  if ($.gtB(j, 0)) {
    locators = $.CTC23.operator$index$1($.S($.getInterceptor(loc).substring$1(loc, $.add(j, 1))) + " " + $.S($.getInterceptor(loc).substring$2(loc, 0, j)));
    if (!(locators == null))
      return locators;
  }
...
$.locateToView = function(mctx, view, location$, anchor, x, y) {
  ...
  if (!(anchor == null)) {
    ...
    $.index($._anchorXLocators(), $.index(locators, 0)).call$3($.add(x, mi.left), $.CTC25, view);
    $.index($._anchorYLocators(), $.index(locators, 1)).call$3($.add(y, mi.top), $.CTC25, view);
  }
  diff = $.add(mi.left, mi.right);
  if (!$.eqB(diff, 0))
...
$.CanvasCircle$ = function() {
  return new $.CanvasCircle(null);
};

$.Ball$ = function(radius, speed, size, color) {
  return new $.Ball(size, radius, speed, color);
};
...
$.CTC15 = Isolate.makeConstantList([]);
$.CTC33 = Isolate.makeConstantList([1, 0]);
$.CTC34 = Isolate.makeConstantList([2, 0]);
$.CTC9 = new Isolate.$isolateProperties.ConstantMap(0, {}, Isolate.$isolateProperties.CTC15);
$.CTC35 = new Isolate.$isolateProperties.Returns("_NodeList");
$.CTC36 = new Isolate.$isolateProperties.Creates("_NodeList");
$.CTC22 = new Isolate.$isolateProperties.AmountType("ratio");
$.CTC37 = new Isolate.$isolateProperties.Creates("=List");
$.CTC38 = Isolate.makeConstantList([1, 4]);
$.CTC39 = Isolate.makeConstantList([2, 4]);
...
$.CTC41 = Isolate.makeConstantList([0, 1]);
$.CTC42 = Isolate.makeConstantList([0, 2]);
$.CTC43 = Isolate.makeConstantList([3, 0]);
$.CTC21 = new Isolate.$isolateProperties.AmountType("flex");
$.CTC44 = Isolate.makeConstantList([4, 2]);
$.CTC11 = $.createRuntimeType('String');
$.CTC45 = Isolate.makeConstantList([3, 1]);
$.CTC46 = Isolate.makeConstantList([0, 3]);
$.CTC19 = new Isolate.$isolateProperties.AmountType("none");
$.CTC47 = Isolate.makeConstantList([4, 1]);
$.CTC18 = new Isolate.$isolateProperties.AmountType("fixed");
$.CTC48 = Isolate.makeConstantList([3, 4]);
$.CTC49 = Isolate.makeConstantList([3, 2]);
$.CTC50 = Isolate.makeConstantList([1, 3]);
$.CTC51 = Isolate.makeConstantList([2, 1]);
$.CTC = new Isolate.$isolateProperties.NullThrownError();
$.CTC52 = Isolate.makeConstantList([4, 3]);
$.CTC53 = Isolate.makeConstantList([1, 1]);
$.CTC54 = new Isolate.$isolateProperties.Creates("MutationRecord");
$.CTC29 = Isolate.makeConstantList(["abort", "click", "dblclickdrag", "dragEnd", "dragEnter", "dragLeave", "dragOver", "dragStart", "drop", "error", "keyDown", "keyPress", "keyUp", "load", "mouseDown", "mouseMove", "mouseOut", "mouseOver", "mouseUp", "mouseWheel", "reset", "scroll", "select", "submit", "unload"]);
$.CTC55 = Isolate.makeConstantList([1, 2]);
$.CTC56 = Isolate.makeConstantList([2, 2]);
$.CTC16 = new Isolate.$isolateProperties._AnchorOfRoot();
$.CTC26 = new Isolate.$isolateProperties.UIException("listener required");
$.CTC57 = new Isolate.$isolateProperties.Creates("IDBRequest");
$.CTC58 = new Isolate.$isolateProperties.Returns("IDBRequest");
$.CTC25 = new Isolate.$isolateProperties._AnchorOfPoint();
$.CTC20 = new Isolate.$isolateProperties.AmountType("content");
...
$.AmountType_NONE = Isolate.$isolateProperties.CTC19;
$.AmountType_FIXED = Isolate.$isolateProperties.CTC18;
$.AmountType_FLEX = Isolate.$isolateProperties.CTC21;
$.AmountType_RATIO = Isolate.$isolateProperties.CTC22;
$.AmountType_CONTENT = Isolate.$isolateProperties.CTC20;
...
$.canvas = null;
$.CSS__nsnms = null;
$.EMPTY_LIST = Isolate.$isolateProperties.CTC15;
...
$.$defineNativeClass('UIEvent', {"": ["pageX>", "pageY>"],
 get$view: function() {
  return $._convertNativeToDart_Window(this.get$_liblib$_view());
},
 get$_liblib$_view: function() {
  return this.view;
},
...
// 37 !leaf
(function() {
  var v0_Uint8Array = 'Uint8Array|Uint8ClampedArray', v1__CSSValueList = 'CSSValueList|WebKitCSSTransformValue|WebKitCSSFilterValue', v2_Text = 'Text|CDATASection', v3_ComponentTransferFunctionElement = 'SVGComponentTransferFunctionElement|SVGFEFuncAElement|SVGFEFuncBElement|SVGFEFuncGElement|SVGFEFuncRElement', v4_MediaElement = 'HTMLMediaElement|HTMLAudioElement|HTMLVideoElement', v5_SvgElement = [v3_ComponentTransferFunctionElement, 'SVGElement|SVGAElement|SVGAltGlyphDefElement|SVGAltGlyphItemElement|SVGAnimationElement|SVGAnimateColorElement|SVGAnimateElement|SVGAnimateMotionElement|SVGAnimateTransformElement|SVGSetElement|SVGCircleElement|SVGClipPathElement|SVGCursorElement|SVGDefsElement|SVGDescElement|SVGEllipseElement|SVGFEBlendElement|SVGFEColorMatrixElement|SVGFEComponentTransferElement|SVGFECompositeElement|SVGFEConvolveMatrixElement|SVGFEDiffuseLightingElement|SVGFEDisplacementMapElement|SVGFEDistantLightElement|SVGFEDropShadowElement|SVGFEFloodElement|SVGFEGaussianBlurElement|SVGFEImageElement|SVGFEMergeElement|SVGFEMergeNodeElement|SVGFEMorphologyElement|SVGFEOffsetElement|SVGFEPointLightElement|SVGFESpecularLightingElement|SVGFESpotLightElement|SVGFETileElement|SVGFETurbulenceElement|SVGFilterElement|SVGFontElement|SVGFontFaceElement|SVGFontFaceFormatElement|SVGFontFaceNameElement|SVGFontFaceSrcElement|SVGFontFaceUriElement|SVGForeignObjectElement|SVGGElement|SVGGlyphElement|SVGGlyphRefElement|SVGGradientElement|SVGLinearGradientElement|SVGRadialGradientElement|SVGHKernElement|SVGImageElement|SVGLineElement|SVGMPathElement|SVGMarkerElement|SVGMaskElement|SVGMetadataElement|SVGMissingGlyphElement|SVGPathElement|SVGPatternElement|SVGPolygonElement|SVGPolylineElement|SVGRectElement|SVGScriptElement|SVGStopElement|SVGStyleElement|SVGSVGElement|SVGSwitchElement|SVGSymbolElement|SVGTextContentElement|SVGTextPathElement|SVGTextPositioningElement|SVGAltGlyphElement|SVGTRefElement|SVGTSpanElement|SVGTextElement|SVGTitleElement|SVGUseElement|SVGVKernElement|SVGViewElement'].join('|'), v6_MouseEvent = 'MouseEvent|WheelEvent', v7_UIEvent = [v6_MouseEvent, 'UIEvent|CompositionEvent|KeyboardEvent|TextEvent|TouchEvent|SVGZoomEvent'].join('|'), v8_CharacterData = [v2_Text, 'CharacterData|Comment'].join('|'), v9_Document = 'Document|HTMLDocument|SVGDocument', v10_DocumentFragment = 'DocumentFragment|ShadowRoot', v11_Element = [v4_MediaElement, v5_SvgElement, 'Element|HTMLElement|HTMLAnchorElement|HTMLAppletElement|HTMLAreaElement|HTMLBRElement|HTMLBaseElement|HTMLBaseFontElement|HTMLBodyElement|HTMLButtonElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDirectoryElement|HTMLDivElement|HTMLEmbedElement|HTMLFieldSetElement|HTMLFontElement|HTMLFormElement|HTMLFrameElement|HTMLFrameSetElement|HTMLHRElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLIFrameElement|HTMLImageElement|HTMLInputElement|HTMLKeygenElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMapElement|HTMLMarqueeElement|HTMLMenuElement|HTMLMetaElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLObjectElement|HTMLOptGroupElement|HTMLOptionElement|HTMLOutputElement|HTMLParagraphElement|HTMLParamElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLSelectElement|HTMLShadowElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTextAreaElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement'].join('|'), v12_AbstractWorker = 'AbstractWorker|SharedWorker|Worker', v13_IDBRequest = 'IDBRequest|IDBOpenDBRequest|IDBVersionChangeRequest', v14_MediaStream = 'MediaStream|LocalMediaStream', v15_Node = [v8_CharacterData, v9_Document, v10_DocumentFragment, v11_Element, 'Node|Attr|DocumentType|EntityReference|Notation|ProcessingInstruction'].join('|'), v16_WorkerContext = 'WorkerContext|DedicatedWorkerContext|SharedWorkerContext';
  $.dynamicSetMetadata([['Uint8Array', v0_Uint8Array], ['WorkerContext', v16_WorkerContext], ['CSSValueList', v1__CSSValueList], ['NodeList', 'NodeList|RadioNodeList'], ['AbstractWorker', v12_AbstractWorker], ['ArrayBufferView', [v0_Uint8Array, 'ArrayBufferView|DataView|Float32Array|Float64Array|Int16Array|Int32Array|Int8Array|Uint16Array|Uint32Array'].join('|')], ['AudioParam', 'AudioParam|AudioGain'], ['Blob', 'Blob|File'], ['CSSRule', 'CSSRule|CSSCharsetRule|CSSFontFaceRule|CSSImportRule|WebKitCSSKeyframeRule|WebKitCSSKeyframesRule|CSSMediaRule|CSSPageRule|CSSStyleRule|CSSUnknownRule'], ['CSSValue', [v1__CSSValueList, 'CSSValue|CSSPrimitiveValue|SVGColor|SVGPaint'].join('|')], ['Text', v2_Text], ['CharacterData', v8_CharacterData], ['DOMTokenList', 'DOMTokenList|DOMSettableTokenList'], ['SVGComponentTransferFunctionElement', v3_ComponentTransferFunctionElement], ['Document', v9_Document], ['DocumentFragment', v10_DocumentFragment], ['HTMLMediaElement', v4_MediaElement], ['SVGElement', v5_SvgElement], ['Element', v11_Element], ['Entry', 'Entry|DirectoryEntry|FileEntry'], ['EntrySync', 'EntrySync|DirectoryEntrySync|FileEntrySync'], ['MouseEvent', v6_MouseEvent], ['UIEvent', v7_UIEvent], ['Event', [v7_UIEvent, 'Event|WebKitAnimationEvent|AudioProcessingEvent|BeforeLoadEvent|CloseEvent|CustomEvent|DeviceMotionEvent|DeviceOrientationEvent|ErrorEvent|HashChangeEvent|IDBVersionChangeEvent|IDBVersionChangeEvent|MediaKeyEvent|MediaStreamEvent|MediaStreamTrackEvent|MessageEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|ProgressEvent|XMLHttpRequestProgressEvent|RTCDataChannelEvent|RTCIceCandidateEvent|SpeechInputEvent|SpeechRecognitionError|SpeechRecognitionEvent|StorageEvent|TrackEvent|WebKitTransitionEvent|WebGLContextEvent'].join('|')], ['IDBRequest', v13_IDBRequest], ['MediaStream', v14_MediaStream], ['Node', v15_Node], ['EventTarget', [v12_AbstractWorker, v13_IDBRequest, v14_MediaStream, v15_Node, v16_WorkerContext, 'EventTarget|AudioContext|BatteryManager|DOMApplicationCache|EventSource|FileReader|FileWriter|XMLHttpRequest|XMLHttpRequestUpload|IDBDatabase|IDBTransaction|DOMWindow|MediaController|MediaSource|MediaStreamTrack|MediaStreamTrackList|MessagePort|Notification|PeerConnection00|Performance|RTCDataChannel|RTCPeerConnection|SourceBufferList|SpeechRecognition|TextTrack|TextTrackCue|TextTrackList|WebKitNamedFlow|WebSocket|SVGElementInstance'].join('|')], ['HTMLCollection', 'HTMLCollection|HTMLOptionsCollection'], ['IDBCursor', 'IDBCursor|IDBCursorWithValue'], ['StyleSheet', 'StyleSheet|CSSStyleSheet']]);
})();
...
//@ sourceMappingURL=CircleOnCanvas.dart.js.map