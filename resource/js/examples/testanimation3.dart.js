...
$$.TestAnimation3 = {"":
 ["sanity?", "brow2", "brow1", "cube", "_container", "_dlgInfos", "_mainView", "_title"],
 super: "Activity",
 onCreate_$0: function() {
  ...
  box.set$left(48);
  box.set$top(48);
  box.get$style().set$border('2px dashed #CCCCCC');
  this.get$mainView().addChild$1(box);
  var views = $.createCube(100);
  this.cube = $.index(views, 0);
  this.cube.set$left(250);
  this.cube.set$top(250);
  this.brow1 = $.index(views, 1);
  this.brow2 = $.index(views, 2);
  this.get$mainView().addChild$1(this.cube);
  var range = $._Rectangle$(50, 50, 446, 446);
  var element = this.cube.get$node();
  t1.inertialMotion_4 = null;
  t1.recoveryMotion_5 = null;
  $._DragGesture__DragGesture(element, null, false, new $.TestAnimation3_onCreate__anon(range), -1, new $.TestAnimation3_onCreate__anon0(element, t1), new $.TestAnimation3_onCreate__anon1(element, 0.0005, t1, range, this), null);
 },
 setSanity$1: function(x) {
  this.sanity = x;
  var t1 = $.createColor(this.sanity);
  this.cube.get$node().get$style().set$backgroundColor(t1);
  if (typeof x !== 'number') throw $.iae(x);
  t1 = 'rotate(' + $.S($.toInt((1 - x) * 30)) + 'deg)';
  this.brow1.get$style().set$transform(t1);
  t1 = 'rotate(' + $.S($.toInt((x - 1) * 30)) + 'deg)';
  this.brow2.get$style().set$transform(t1);
 }
};
...
$$._OnDemandMap = {"":
 ...
 getValues$0: function() {
  var t1 = this._lib7_map;
  return !(t1 == null) ? t1.getValues$0() : $.CTC59;
 },
 getKeys$0: function() {
  var t1 = this._lib7_map;
  return !(t1 == null) ? t1.getKeys$0() : $.CTC59;
 },
 forEach$1: function(f) {
  var t1 = this._lib7_map;
...
$$.View = {"":
 ["_inDoc", "_hidden", "_layout", "_profile", "_height", "_width", "_lib4_top", "_left", "_node", "_style", "_classes", "_mntAttrs", "_dataAttrs!", "_evlInfo", "_childInfo?", "_virtIS=", "_prevSibling=", "_nextSibling=", "_lib4_parent!", "_lib4_uuid", "_id?"],
 super: "Object",
 toString$0: function() {
 ...
 _addToDoc$6: function(node, outer, inner, before, keepId, location$) {
  var t1 = outer === true;
  if (t1 && (keepId === true && $.isEmpty(node.get$id()) !== true)) this._lib4_uuid = node.get$id();
 ...
 get$uuid: function() {
  if (this._lib4_uuid == null) {
    var t1 = $.View__uuidNext;
    $.View__uuidNext = $.add(t1, 1);
    this._lib4_uuid = $.StringUtil_encodeId(t1, $.viewConfig.get$uuidPrefix());
  }
  return this._lib4_uuid;
 },
...
$$._SubviewList = {"":
 ...
 super: "AbstractList",
 insertRange$3: function(start, length$, initialValue) {
  if (!$.eqB(length$, 1)) throw $.captureStackTrace($.CTC54);
  if (initialValue == null) throw $.captureStackTrace($.CTC55);
 ...
 operator$indexSet$2: function(index, value) {
  if (value == null) throw $.captureStackTrace($.CTC53);
...
$$._WCIterator = {"":
 ...
 super: "Object",
 next$0: function() {
  var t1 = this._lib4_next;
  if (t1 == null) throw $.captureStackTrace($.CTC4);
  this._lib4_next = t1.get$nextSibling();
  return t1;
 },
 hasNext$0: function() {
...
$$._EventListenerInfo = {"":
 ...
 add$2: function(type, listener) {
  var t1 = ({});
  if (listener == null) throw $.captureStackTrace($.CTC43);
...
$$.Section = {"":
 ["_fellows", "_inDoc", "_hidden", "_layout", "_profile", "_height", "_width", "_lib4_top", "_left", "_node", "_style", "_classes", "_mntAttrs", "_dataAttrs", "_evlInfo", "_childInfo", "_virtIS", "_prevSibling", "_nextSibling", "_lib4_parent", "_lib4_uuid", "_id"],
 super: "View",
 get$domTag_: function() {
  return 'section';
 },
...
$$.ViewEvent = {"":
 ["currentTarget!", "target=", "_propStop", "_offsetReady", "_offset", "_stamp", "_lib2_type", "_domEvt"],
 super: "Object",
 toString$0: function() {
...
$$.PopupEvent = {"":
 ["_source", "currentTarget", "target", "_propStop", "_offsetReady", "_offset", "_stamp", "_lib2_type", "_domEvt"],
 super: "ViewEvent",
 get$source: function() {
  return this._source;
 },
...
$$.Motion = {"":
 ["data", "_stateFlag=", "_lib8_state=", "_lib8_task", "_lib8_end?", "_lib8_move?", "_lib8_start"],
 super: "Object",
 isPaused$0: function() {
  return $.eq(this._stateFlag, 2);
 },
 stop$0: function() {
  $._getAnimator().remove$1(this._lib8_task);
  this._lib8_state = null;
  this._stateFlag = 0;
 },
 run$0: function() {
 ...
 onEnd$1: function(state) {
  !(this.get$_lib8_end() == null) && this._lib8_end$1(state);
 },
 onMove$1: function(state) {
  return this.get$_lib8_move() == null || this._lib8_move$1(state) === true;
 },
 onStart$1: function(state) {
  !(this._lib8_start == null) && this._lib8_start$1(state);
 },
 _lib8_end$1: function(arg0) { return this._lib8_end.$call$1(arg0); },
 _lib8_move$1: function(arg0) { return this._lib8_move.$call$1(arg0); },
...
$$.EasingMotion = {"":
 ["duration", "mode", "easing", "action", "data", "_stateFlag", "_lib8_state", "_lib8_task", "_lib8_end", "_lib8_move", "_lib8_start"],
 super: "Motion",
...
$$.TestAnimation3_onCreate__anon0 = {"":
 ["element_7", "box_3"],
 super: "Closure",
 $call$1: function(dstate) {
  var t1 = this.box_3.inertialMotion_4;
  !(t1 == null) && t1.stop$0();
  t1 = this.box_3.recoveryMotion_5;
  !(t1 == null) && t1.stop$0();
  return this.element_7;
 }
};

$$.TestAnimation3_onCreate__anon1 = {"":
 ["element_11", "deceleration_10", "box_3", "range_9", "this_8"],
 super: "Closure",
 $call$1: function(dstate) {
  var t1 = ({});
  var vel = dstate.get$velocity();
  t1.speed_1 = $.VectorUtil_norm(vel);
  if ($.eqB(t1.speed_1, 0)) {
    var initSanity = this.this_8.get$sanity();
    if (typeof initSanity !== 'number') throw $.iae(initSanity);
    var diffSanity = 1 - initSanity;
    var recoveryMotion = $.EasingMotion$(new $.TestAnimation3_onCreate__anon2(this.this_8, diffSanity, initSanity), new $.TestAnimation3_onCreate__anon3(), 'once', 500, null, null, true);
    this.box_3.recoveryMotion_5 = recoveryMotion;
    return true;
  }
  var unitv = $.div(vel, t1.speed_1);
  t1.pos_2 = $.DOMQuery_DOMQuery(this.element_11).get$offset();
  var inertialMotion = $.Motion$(null, new $.TestAnimation3_onCreate__anon4(this.this_8, this.element_11, t1, this.deceleration_10, unitv, this.range_9), new $.TestAnimation3_onCreate__anon5(this.this_8, this.box_3), true);
  this.box_3.inertialMotion_4 = inertialMotion;
  return true;
 }
};

$$.TestAnimation3_onCreate__anon2 = {"":
 ["this_14", "diffSanity_13", "initSanity_12"],
 super: "Closure",
 $call$1: function(x) {
  this.this_14.setSanity$1($.add($.mul(this.diffSanity_13, x), this.initSanity_12));
 }
};

$$.TestAnimation3_onCreate__anon3 = {"":
 [],
 super: "Closure",
 $call$1: function(x) {
  return $.mul(x, x);
...
$$.TestAnimation3_onCreate__anon4 = {"":
 ["this_19", "element_18", "box_0", "deceleration_17", "unitv_16", "range_15"],
 super: "Closure",
 $call$1: function(mstate) {
  var elapsed = mstate.get$elapsedTime();
  var t1 = this.box_0;
  var pos = $.add(t1.pos_2, $.mul($.mul(this.unitv_16, t1.speed_1), elapsed));
  this.box_0.pos_2 = pos;
  if ($.ltB(this.box_0.pos_2.get$x(), this.range_15.get$left()) || $.gtB(this.box_0.pos_2.get$x(), this.range_15.get$right())) {
    t1 = this.unitv_16;
    t1.set$x($.mul(t1.get$x(), -1));
    var speed = $.mul(this.box_0.speed_1, 0.8);
    this.box_0.speed_1 = speed;
    t1 = this.this_19;
    t1.setSanity$1($.mul(t1.get$sanity(), 0.8));
  }
  if ($.ltB(this.box_0.pos_2.get$y(), this.range_15.get$top()) || $.gtB(this.box_0.pos_2.get$y(), this.range_15.get$bottom())) {
    t1 = this.unitv_16;
    t1.set$y($.mul(t1.get$y(), -1));
    speed = $.mul(this.box_0.speed_1, 0.8);
    this.box_0.speed_1 = speed;
    t1 = this.this_19;
    t1.setSanity$1($.mul(t1.get$sanity(), 0.8));
  }
  pos = this.range_15.snap$1(this.box_0.pos_2);
  this.box_0.pos_2 = pos;
  t1 = $.CSS_px($.toInt(this.box_0.pos_2.get$left()));
  this.element_18.get$style().set$left(t1);
  t1 = $.CSS_px($.toInt(this.box_0.pos_2.get$top()));
  this.element_18.get$style().set$top(t1);
  speed = $.Math_max(0, $.sub(this.box_0.speed_1, $.mul(this.deceleration_17, elapsed)));
  this.box_0.speed_1 = speed;
  return $.gt(this.box_0.speed_1, 0);
 }
};

$$.TestAnimation3_onCreate__anon5 = {"":
 ["this_20", "box_3"],
 super: "Closure",
 $call$1: function(mstate) {
  var initSanity = this.this_20.get$sanity();
  if (typeof initSanity !== 'number') throw $.iae(initSanity);
  var diffSanity = 1 - initSanity;
  var recoveryMotion = $.EasingMotion$(new $.TestAnimation3_onCreate__anon6(this.this_20, diffSanity, initSanity), new $.TestAnimation3_onCreate__anon7(), 'once', 500, null, null, true);
  this.box_3.recoveryMotion_5 = recoveryMotion;
 }
};

$$.TestAnimation3_onCreate__anon6 = {"":
 ["this_23", "diffSanity_22", "initSanity_21"],
 super: "Closure",
 $call$1: function(x) {
  this.this_23.setSanity$1($.add($.mul(this.diffSanity_22, x), this.initSanity_21));
 }
};

$$.TestAnimation3_onCreate__anon7 = {"":
 [],
 super: "Closure",
 $call$1: function(x) {
  return $.mul(x, x);
...
$$.anon = {"":
 ...
 $call$2: function(time, elapsed) {
  if ($.eqB(this.this_0.get$_stateFlag(), 0)) {
    ...
    this.this_0.set$_lib8_state(t1);
    t1 = this.this_0;
    t1.onStart$1(t1.get$_lib8_state());
    this.this_0.set$_stateFlag(1);
  }
  this.this_0.get$_lib8_state()._snapshot$2(time, elapsed);
  switch (this.this_0.get$_stateFlag()) {
    case 1:
      if (this.this_0.get$_lib8_state().isPaused$0() === true) {
        this.this_0.get$_lib8_state()._resume$1(time);
        t1 = this.this_0;
        t1.onResume$1(t1.get$_lib8_state());
      }
      t1 = this.this_0;
      var cont = t1.onMove$1(t1.get$_lib8_state());
      if (cont == null) cont = true;
      if (cont !== true) {
        t1 = this.this_0;
        t1.onEnd$1(t1.get$_lib8_state());
        this.this_0.set$_lib8_state(null);
        this.this_0.set$_stateFlag(0);
      }
      return cont;
    case 2:
      if (this.this_0.get$_lib8_state().isPaused$0() !== true) {
        this.this_0.get$_lib8_state()._pause$1(time);
        t1 = this.this_0;
        t1.onPause$1(t1.get$_lib8_state());
      }
      return true;
  }
 }
...
$._ViewImpl_getDOMEventDispatcher = function(type) {
  if ($._ViewImpl__domEvtDisps == null) {
    ...
    for (var t1 = $.iterator($.CTC44); t1.hasNext$0() === true; ) {
      var t2 = t1.next$0();
...
$.TestAnimation3$ = function() {
  var t1 = new $.TestAnimation3(1, null, null, null, null, [], null, '');
  t1.Activity$0();
  return t1;
};
...
$.Motion$ = function(start, move, end, autorun) {
  var t1 = new $.Motion(null, 0, null, null, end, move, start);
  t1.Motion$4(start, move, end, autorun);
  return t1;
};
...
$.AnchorRelation_position = function(view, x, y, location$) {
  if (location$ == null || $.isEmpty(location$) === true) {
    ...
    $.index($._anchorXHandlers(), $.index(handlers, 0)).$call$3(x, $.CTC61, view);
    $.index($._anchorYHandlers(), $.index(handlers, 1)).$call$3(y, $.CTC61, view);
  }
};
...
$.CSS_color = function(red, green, blue, alpha) {
  return !(alpha == null) ? 'rgba(' + $.S(red) + ',' + $.S(green) + ',' + $.S(blue) + ',' + $.S(alpha) + ')' : '#' + $.S($.StringUtil_toHexString(red, 2)) + $.S($.StringUtil_toHexString(green, 2)) + $.S($.StringUtil_toHexString(blue, 2));
};
...
$.StringUtil_toHexString = function(value, digits) {
  $.StringUtil__init();
  var codes = $.ListFactory_List(null);
  var val = $.toInt(value);
  if ($.ltB(val, 0)) {
    if (typeof val !== 'number') throw $.iae(val);
    var val0 = 4294967295 + val + 1;
    val = val0;
  }
  if (val !== (val | 0)) return $.StringUtil_toHexString$bailout(1, val, digits, codes);
  for (; val > 0; ) {
    var cc = val & 15;
    val = $.shr(val, 4);
    if (cc < 10) {
      ...
      t1 = $.sub($.StringUtil__CC_a, 10);
      if (typeof t1 !== 'number') throw $.iae(t1);
      cc += t1;
    }
    $.insertRange$3(codes, 0, 1, cc);
  }
  val = $.sub(digits, codes.length);
  $.gtB(val, 0) && $.insertRange$3(codes, 0, val, $.StringUtil__CC_0);
  return $.isEmpty(codes) === true ? '0' : $.Strings_String$fromCharCodes(codes);
};
...
$.dynamicFunction = function(name$) {
  ...
  var methods = ({});
  var dartMethod = (Object.getPrototypeOf($.CTC63)[name$]);
...
$.createColor = function(x) {
  if (typeof x !== 'number') throw $.iae(x);
  return $.CSS_color($.toInt(92 * x), $.toInt(115 * x), $.toInt(229 * x), null);
};
...
$.createCube = function(size) {
  ...
  v.set$width(size);
  v.set$height(size);
  v.get$style().set$border('2px solid #3D4C99');
  v.get$style().set$borderRadius('10px');
  var t1 = $.createColor(1);
  v.get$style().set$backgroundColor(t1);
  v.get$style().set$userSelect('none');
  v.get$style().set$zIndex('10');
  var s = $.toInt($.div($.sub(size, 4), 8));
  var brow1 = $.View$();
  var brow2 = $.View$();
  t1 = $.mul(s, 2);
  brow2.set$width(t1);
  ...
  brow2.set$height(0);
  brow1.set$height(0);
  if (typeof s !== 'number') throw $.iae(s);
  t1 = $.toInt(2.5 * s);
  brow2.set$top(t1);
  brow1.set$top(t1);
  brow1.set$left(s);
  brow2.set$left(s * 5);
  brow2.get$style().set$borderBottom('2px solid #FFFFFF');
  brow1.get$style().set$borderBottom('2px solid #FFFFFF');
  v.addChild$1(brow1);
  v.addChild$1(brow2);
  var eye1 = $.View$();
  var eye2 = $.View$();
  ...
  eye1.set$left(2 * s - 4);
  eye2.set$left(6 * s - 4);
  eye2.get$style().set$border('4px solid #FFFFFF');
  eye1.get$style().set$border('4px solid #FFFFFF');
  eye2.get$style().set$borderRadius('4px');
  eye1.get$style().set$borderRadius('4px');
  v.addChild$1(eye1);
  v.addChild$1(eye2);
  var mouth = $.View$();
  mouth.set$height(0);
  mouth.set$width(0);
  mouth.get$style().set$borderTop('10px solid transparent');
  mouth.get$style().set$borderBottom('10px solid #FFFFFF');
  mouth.get$style().set$borderRight('6px solid transparent');
  mouth.get$style().set$borderLeft('6px solid transparent');
  mouth.set$left(t1 - 6);
  mouth.set$top(5 * s);
  v.addChild$1(mouth);
...
$.CSS_name = function(propertyName) {
  if ($.CSS__nsnms == null) {
    ...
    for (t1 = $.iterator($.CTC56); t1.hasNext$0() === true; ) {
      var t2 = t1.next$0();
      $.add$1($.CSS__nsnms, t2);
    }
  }
...
$.getFunctionForTypeNameOf = function() {
  ...
  if ($.contains$1(userAgent, $.CTC62) === true) return $.typeNameInChrome;
...
$.CSSStyleDeclarationImpl__check = function(propertyName) {
  if ($.CSSStyleDeclarationImpl__illnms == null) {
    ...
    for (var t1 = $.iterator($.CTC57); t1.hasNext$0() === true; ) {
      var t2 = t1.next$0();
  ...
  if ($.startsWith(propertyName, 'margin') === true) throw $.captureStackTrace($.CTC58);
};
...
$.EasingMotion$ = function(action, easing, mode, duration, start, end, autorun) {
  var t1 = new $.EasingMotion(duration, mode, easing, action, null, 0, null, null, end, null, start);
...
$.StringUtil_toHexString$bailout = function(state, val, digits, codes) {
  for (; $.gtB(val, 0); ) {
    var cc = $.and(val, 15);
    val = $.shr(val, 4);
    $.insertRange$3(codes, 0, 1, $.ltB(cc, 10) ? $.add(cc, $.StringUtil__CC_0) : $.add(cc, $.sub($.StringUtil__CC_a, 10)));
  }
  val = $.sub(digits, codes.length);
  $.gtB(val, 0) && $.insertRange$3(codes, 0, val, $.StringUtil__CC_0);
  return $.isEmpty(codes) === true ? '0' : $.Strings_String$fromCharCodes(codes);
...
$.CTC55 = new Isolate.$isolateProperties.IllegalArgumentException('Require initialValue');
...
$.CTC54 = new Isolate.$isolateProperties.IllegalArgumentException('Allow only one view');
...
$.CTC58 = new Isolate.$isolateProperties.UIException('You can\'t change margin');
...
$.CTC57 = Isolate.makeConstantList(['left', 'top', 'right', 'bottom', 'width', 'height', 'display']);
...
$.CTC44 = Isolate.makeConstantList(['blur', 'click', 'focus', 'mouseDown', 'mouseMove', 'mouseOut', 'mouseOver', 'mouseUp', 'mouseWheel', 'scroll']);
$.CTC61 = new Isolate.$isolateProperties._AnchorOfPoint();
$.CTC62 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, 'Chrome|DumpRenderTree');
...
$.$defineNativeClass('Element', ["style?", "offsetParent?", "nextElementSibling?", "innerHTML!", "id=", "hidden?"], {
