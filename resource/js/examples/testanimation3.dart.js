...
$$.JSInvocationMirror = {"": ["memberName>", "_internalName", "_kind", "_liblib5$_arguments", "_namedArgumentNames", "_namedIndices"],
 "super": "Object",
...
$$._AllMatchesIterator = {"": ["_re", "_str", "_liblib5$_next=", "_done"],
 "super": "Object",
 next$0: function() {
  if (this.get$hasNext() !== true)
    throw $.$$throw($.StateError$("No more elements"));
  var next = this._liblib5$_next;
 ...
 get$hasNext: function() {
  if (this._done)
    return false;
  else if (!(this._liblib5$_next == null))
    return true;
  this._liblib5$_next = this._re.firstMatch$1(this._str);
  if (this._liblib5$_next == null) {
    this._done = true;
    return false;
  } else
    return true;
...
$$.IllegalJSRegExpException = {"": ["_liblib0$_pattern", "_errmsg"],
 "super": "Object",
 toString$0: function() {
...
$$._FutureImpl = {"": ["_isComplete", "_liblib0$_value", "_exception", "_stackTrace", "_exceptionHandled", "_throwOnException", "_successListeners", "_exceptionHandlers", "_completionListeners"],
 "super": "Object",
 get$value: function() {
...
$$._HashMapImpl = {"": ["_liblib0$_keys>", "_values", "_loadLimit", "_numberOfEntries", "_numberOfDeleted"],
 "super": "Object",
 _probeForAdding$1: function(key) {
  ...
  for (insertionIndex = -1, numberOfProbes = 1; true; numberOfProbes = numberOfProbes0) {
    ...
    if (existingKey == null) {
      ...
      return hash;
    else if (insertionIndex < 0 && existingKey === $.CTC10)
      insertionIndex = hash;
          ...
          switch (state0) {
            ...
            case 3:
              ...
              if (existingKey == null) {
                ...
                return hash;
              else if ($.ltB(insertionIndex, 0) && existingKey === $.CTC10)
                insertionIndex = hash;
              numberOfProbes0 = numberOfProbes + 1;
              t1 = this._liblib0$_keys;
              hash = $._HashMapImpl__nextProbe(hash, numberOfProbes, $.getInterceptor(t1).get$length(t1));
 ...
 _probeForLookup$1: function(key) {
  ...
  for (numberOfProbes = 1; true; numberOfProbes = numberOfProbes0) {
    existingKey = $.index(this._liblib0$_keys, hash);
    if (existingKey == null)
      return -1;
 ...
 _grow$1: function(newCapacity) {
  ...
  for (i = 0; i < capacity; ++i) {
    ...
    $.indexSet(this._liblib0$_keys, newIndex, key);
 ...
 clear$0: function() {
  ...
  for (i = 0; i < length$; ++i) {
    $.indexSet(this._liblib0$_keys, i, null);
 ...
 oprator$indexSet$2: function(key, value) {
  ...
  if ($.index(this._liblib0$_keys, index) == null || $.index(this._liblib0$_keys, index) === $.CTC10)
    this._numberOfEntries = $.add(this._numberOfEntries, 1);
  $.indexSet(this._liblib0$_keys, index, key);
 ...
 forEach$1: function(f) {
  ...
  for (i = 0; i < length$; ++i) {
    key = $.index(this._liblib0$_keys, i);
    if (!(key == null) && !(key === $.CTC10))
...
$$._LinkedHashMapImpl = {"": ["_list", "_liblib0$_map"],
 "super": "Object",
 oprator$indexSet$2: function(key, value) {
  var t1;
  if (this._liblib0$_map.containsKey$1(key) === true)
    $.index(this._liblib0$_map, key).get$element().set$value(value);
  else {
    t1 = this._list;
    $.getInterceptor(t1).addLast$1(t1, $._KeyValuePair$(key, value, $.getRuntimeTypeInfo(this)[0], $.getRuntimeTypeInfo(this)[1]));
    $.indexSet(this._liblib0$_map, key, this._list.lastEntry$0());
  }
},
 operator$index$1: function(key) {
  var entry = $.index(this._liblib0$_map, key);
  if (entry == null)
    return;
  return entry.get$element().get$value();
},
 remove$1: function(key) {
  var entry = this._liblib0$_map.remove$1(key);
  if (entry == null)
    return;
  entry.remove$0();
  return entry.get$element().get$value();
 ...
 putIfAbsent$2: function(key, ifAbsent) {
  ...
  if (this.operator$index$1(key) == null && this._liblib0$_map.containsKey$1(key) !== true) {
    value = ifAbsent.call$0();
    this.oprator$indexSet$2(key, value);
  }
  return value;
 ...
 containsKey$1: function(key) {
  return this._liblib0$_map.containsKey$1(key);
},
 get$length: function() {
 ...
 _LinkedHashMapImpl$0: function() {
  ...
  this._liblib0$_map = $.HashMap_HashMap(t1, 'DoubleLinkedQueueEntry<_KeyValuePair<' + t2[0] +', ' + t2[1] +'>>');
...
$$.Object = {
 ...
 _initState$2: function($0, $1) {
  return this.noSuchMethod$1($.createInvocationMirror("_initState", "_initState$2",0, [$0, $1], []));
 },
 onEnd$1: function($0) {
 ...
 setElementPosition_$2: function($0, $1) {
  return this.noSuchMethod$1($.createInvocationMirror("setElementPosition_", "setElementPosition_$2",0, [$0, $1], []));
 },
 get$_id: function() {
 ...
 get$elementVelocity: function() {
  return this.noSuchMethod$1($.createInvocationMirror("elementVelocity", "elementVelocity$0",1, [], []));
 },
 get$_set: function() {
 ...
 get$_view: function() {
  return this.noSuchMethod$1($.createInvocationMirror("_view", "_view$0",1, [], []));
 },
 ...
 get$elementStartPosition: function() {
  return this.noSuchMethod$1($.createInvocationMirror("elementStartPosition", "elementStartPosition$0",1, [], []));
 },
 get$values: function() {
 ...
 get$elementPosition: function() {
  return this.noSuchMethod$1($.createInvocationMirror("elementPosition", "elementPosition$0",1, [], []));
 },
 get$opera: function() {
 ...
 get$_gestureStartPosition: function() {
  return this.noSuchMethod$1($.createInvocationMirror("_gestureStartPosition", "_gestureStartPosition$0",1, [], []));
 },
 ...
 get$_liblib9$_tasks: function() {
  return this.noSuchMethod$1($.createInvocationMirror("_tasks", "_liblib9$_tasks$0",1, [], []));
 },
 ...
 get$_pending: function() {
  return this.noSuchMethod$1($.createInvocationMirror("_pending", "_pending$0",1, [], []));
 },
 ...
 get$draggedElement: function() {
  return this.noSuchMethod$1($.createInvocationMirror("draggedElement", "draggedElement$0",1, [], []));
 },
 ...
 get$_liblib0$_keys: function() {
  return this.noSuchMethod$1($.createInvocationMirror("_keys", "_liblib0$_keys$0",1, [], []));
 },
 ...
 get$_disabled: function() {
  return this.noSuchMethod$1($.createInvocationMirror("_disabled", "_disabled$0",1, [], []));
 },
 ...
 set$borderBottom: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("borderBottom=", "borderBottom=$1",2, [$0], []));
 },
 ...
 set$borderRight: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("borderRight=", "borderRight=$1",2, [$0], []));
 },
 ...
 set$borderLeft: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("borderLeft=", "borderLeft=$1",2, [$0], []));
 },
 ...
 set$_liblib8$_state: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("_state=", "_liblib8$_state=$1",2, [$0], []));
 },
 set$nextIsolateId: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("nextIsolateId=", "nextIsolateId=$1",2, [$0], []));
 },
 set$borderTop: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("borderTop=", "borderTop=$1",2, [$0], []));
 },
 ...
 set$zIndex: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("zIndex=", "zIndex=$1",2, [$0], []));
 },
 ...
 set$border: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("border=", "border=$1",2, [$0], []));
 },
 set$_next: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("_next=", "_next=$1",2, [$0], []));
 },
 set$_pending: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("_pending=", "_pending=$1",2, [$0], []));
 }
};
...
$$.SequenceCollection = {
 ...
 contains$1: function(value) {
  ...
  while (true) {
    ...
    t1 = $.getInterceptor(t1).get$length(t1);
    if (typeof t1 !== 'number')
      return this.contains$1$bailout0(1, value, t1, i);
    if (!(i < t1))
      break;
    t1 = this.get$sequence();
    if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
      return this.contains$1$bailout0(2, value, t1, i);
    if (i >= t1.length)
      throw $.ioore(i);
    if ($.eqB(t1[i], value))
      return true;
...
$$.SequenceIterator = {"": ["_sequence", "_liblib0$_position"],
 "super": "Object",
 get$hasNext: function() {
  var t1, t2;
...
$$._StringBufferImpl = {"": ["_buffer", "_liblib0$_length"],
 "super": "Object",
 get$length: function() {
...
$$._FrozenElementListIterator = {"": ["_liblib3$_list", "_liblib3$_index"],
 "super": "Object",
 next$0: function() {
  var t1, t2;
  if (this.get$hasNext() !== true)
...
$$.FilteredElementList = {"": ["_liblib3$_node", "_childNodes"],
 "super": "Object",
 get$_filtered: function() {
  var t1, t2;
  t1 = this._childNodes;
...
$$.FixedSizeListIterator = {"": ["_length", "_array", "_pos"],
...
$$.View = {"": ["_uuid", "_parent=", "_nextSibling=", "_prevSibling=", "_virtIS=", "_childInfo", "_evlInfo", "_dataAttrs<", "_mntAttrs", "_annos", "_style", "_node", "_left", "_liblib$_top>", "_width", "_height", "_profile", "_layout", "_inDoc"],
 "super": "Object",
 get$className: function() {
 ...
 get$top: function() {
  return this._liblib$_top;
},
 set$top: function(top$) {
  var t1;
  this._liblib$_top = top$;
  t1 = $.CSS_px(top$);
...
$$.Declaration = {
 ...
 setProperty$2: function(propertyName, value) {
  if (value == null || $.getInterceptor(value).get$isEmpty(value) === true)
    ...
    $.indexSet(this._props, propertyName, $.getInterceptor(value).trim$0(value));
}
};
...
$$._SubviewList = {"": ["_owner", "sequence"],
 ...
 insertRange$3: function(start, length$, initialValue) {
  ...
  if (!(length$ === 1))
    throw $.$$throw($.ArgumentError$("Allow only one view"));
  if (initialValue == null)
    throw $.$$throw($.ArgumentError$("Require initialValue"));
  t1 = $.eqB(start, $.getInterceptor(this).get$length(this));
  t2 = this._owner;
  if (t1)
    t2.addChild$1(initialValue);
  else
    t2.addChild$2(initialValue, this.operator$index$1(start));
},
...
$$._CSSStyleImpl = {"": ["_liblib$_view>"],
 "super": "Object",
 get$_st: function() {
  return this._liblib$_view.get$node().get$style();
},
 getPropertyValue$1: function(propertyName) {
...
$$.Section = {"": ["_fellows", "_uuid", "_parent", "_nextSibling", "_prevSibling", "_virtIS", "_childInfo", "_evlInfo", "_dataAttrs", "_mntAttrs", "_annos", "_style", "_node", "_left", "_liblib$_top", "_width", "_height", "_profile", "_layout", "_inDoc"],
 "super": "View",
 getFellow$1: function(id) {
 ...
 render_$0: function() {
  return $.Element_Element$tag("section");
},
 Section$0: function() {
...
$$._OnDemandMap = {"": ["_creator", "_map"],
 ...
 get$keys: function() {
  var t1 = this._map;
  return !(t1 == null) ? t1.get$keys() : $.CTC19;
},
 get$values: function() {
  var t1 = this._map;
  return !(t1 == null) ? t1.get$values() : $.CTC19;
},
 get$isEmpty: function() {
  var t1 = this._map;
...
$$.VelocityProvider = {"": ["_liblib6$_pos", "_vel", "_time"],
 "super": "Object",
 snapshot$2: function(position, time) {
  var diffTime = $.sub(time, this._time);
  if ($.gtB(diffTime, 0)) {
    this._vel = $.div($.sub(position, this._liblib6$_pos), diffTime);
    this._time = time;
    this._liblib6$_pos = position;
  }
},
...
$$.Rectangle = {"": ["right>", "bottom>", "left", "top"],
 ...
 operator$eq$1: function(other) {
  ...
  if (typeof other === 'object' && other !== null && !!other.is$Rectangle)
    t1 = $.eqB(this.left, other.left) && $.eqB(this.top, other.top) && this.right === other.right && this.bottom === other.bottom;
  else
    t1 = false;
  return t1;
},
 contains$1: function(offset) {
  ...
  if (t1) {
    ...
    t2 = offset.get$left();
    if (typeof t2 !== 'number')
      return this.contains$1$bailout(3, offset, t2, t1);
    t2 = t1 > t2;
    t1 = t2;
    if (t1) {
      t1 = this.top;
      if (typeof t1 !== 'number')
        return this.contains$1$bailout(4, offset, t1);
      t2 = offset.get$top();
      if (typeof t2 !== 'number')
        return this.contains$1$bailout(5, offset, t1, t2);
      t2 = t1 <= t2;
      t1 = t2;
      if (t1) {
        t1 = this.bottom;
        t2 = offset.get$top();
        if (typeof t2 !== 'number')
          return this.contains$1$bailout(6, t2, t1);
        t2 = t1 > t2;
        t1 = t2;
      } else
        t1 = false;
      ...
      if (state0 === 6 || state0 === 5 || state0 === 4 || state0 === 3 || state0 === 0 && t1)
        switch (state0) {
          ...
          case 3:
            ...
            t1 = t2;
          default:
            if (state0 === 6 || state0 === 5 || state0 === 4 || state0 === 0 && t1)
              switch (state0) {
                case 0:
                  t1 = this.top;
                case 4:
...
$$.ViewEvent = {"": ["_liblib2$_type", "_stamp", "_propStop", "target=", "currentTarget<"],
 "super": "Object",
 get$timeStamp: function() {
  return this._stamp;
},
...
$$.DOMEvent = {"": ["_uic", "_keyInf", "cause", "_liblib2$_type", "_stamp", "_propStop", "target", "currentTarget"],
 "super": "ViewEvent",
 get$pageOffset: function() {
  var t1 = this._uic;
...
$$.ViewEventListenerList = {"": ["_liblib2$_ptr>", "_liblib2$_type"],
 "super": "Object",
 ...
 get$isEmpty: function() {
  ...
  return $.getInterceptor(t1).isEmpty$1(t1, this._liblib2$_type);
},
 isEmpty$1: function(arg0) { return this.get$isEmpty().call$1(arg0); }
};

$$.ViewEventListenerMap = {"": ["_liblib2$_ptr>"],
 "super": "Object",
 operator$index$1: function(type) {
...
$$.ViewEvents = {"": ["_liblib2$_ptr", "_lnlist"],
...
$$.BroadcastEvents = {"": ["_liblib2$_ptr", "_lnlist"],
 "super": "ViewEventListenerMap"
};

$$._Broadcaster = {"": ["_liblib2$_listeners", "_on"],
 "super": "Broadcaster",
 get$on: function() {
  return this._on;
},
 sendEvent$2: function(event$, type) {
  return this._liblib2$_listeners.send$2(event$, type);
},
 sendEvent$1: function(event$) {
  return this.sendEvent$2(event$,null)
},
 _Broadcaster$0: function() {
  this._liblib2$_listeners = $._BroadcastListeners$(this);
  this._on = $.BroadcastEvents$(this._liblib2$_listeners);
}
};

$$._BroadcastListeners = {"": ["_liblib2$_owner", "_liblib2$_listeners"],
 "super": "Object",
 isEmpty$1: function(type) {
  var t1, ls;
  t1 = this._liblib2$_listeners;
  if (!(t1 == null)) {
    ls = $.index(t1, type);
    t1 = ls == null || $.getInterceptor(ls).get$isEmpty(ls) === true;
  } else
 ...
 add$2: function(type, listener) {
  ...
  if (listener == null)
    throw $.$$throw($.CTC17);
  t1 = this._liblib2$_listeners.putIfAbsent$2(type, new $._BroadcastListeners_add_anon());
  $.getInterceptor(t1).add$1(t1, listener);
},
 remove$2: function(type, listener) {
  var ls = $.index(this._liblib2$_listeners, type);
 ...
 send$2: function(event$, type) {
  ...
  if (type == null)
    type = event$.get$type();
  ls = $.index(this._liblib2$_listeners, type);
  if (!(ls == null))
    for (t1 = $.List_List$from(ls), $.setRuntimeTypeInfo(t1, []), t1 = $.getInterceptor(t1).iterator$0(t1), dispatched = false; t1.get$hasNext() === true; dispatched = true) {
      t1.next$0().call$1(event$);
      if (event$.get$isPropagationStopped() === true)
...
$$.ActivateEvent = {"": ["_liblib2$_source>", "_liblib2$_type", "_stamp", "_propStop", "target", "currentTarget"],
 "super": "ViewEvent",
 get$source: function() {
...
$$.ChangeEvent = {"": ["_value", "_liblib2$_type", "_stamp", "_propStop", "target", "currentTarget"],
 "super": "ViewEvent",
 get$value: function() {
  return this._value;
},
...
$$.LayoutEvent = {"": ["_context", "_liblib2$_type", "_stamp", "_propStop", "target", "currentTarget"],
 "super": "ViewEvent",
 toString$0: function() {
  ...
  for (t1 = view.get$children(), t1 = $.getInterceptor(t1).iterator$0(t1), width = 0, prevSpacing = null; t1.get$hasNext() === true;) {
    ...
    switch (amt.type) {
      ...
      case $.CTC24:
        ...
        wd = !(wapp == null) && !$.eqB(amt.type, $.CTC24) ? wapp : t2.measureWidth_$1(mctx);
  ...
  for (t1 = view.get$children(), t1 = $.getInterceptor(t1).iterator$0(t1), height = null; t1.get$hasNext() === true;) {
    ...
    switch (amt.type) {
      ...
      case $.CTC24:
        ...
        h = !(happ == null) && !$.eqB(amt.type, $.CTC24) ? happ : t2.measureHeight_$1(mctx);
 ...
 measureHeight$2: function(mctx, view) {
  ...
  for (t1 = view.get$children(), t1 = $.getInterceptor(t1).iterator$0(t1), height = 0, prevSpacing = null; t1.get$hasNext() === true;) {
    ...
    switch (amt.type) {
      ...
      case $.CTC24:
        happ = mctx.getHeightByApp$1(t2);
        hgh = !(happ == null) && !$.eqB(amt.type, $.CTC24) ? happ : t2.measureHeight_$1(mctx);
 ...
 measureWidth$2: function(mctx, view) {
  ...
  for (t1 = view.get$children(), t1 = $.getInterceptor(t1).iterator$0(t1), width = null; t1.get$hasNext() === true;) {
    ...
    switch (amt.type) {
      ...
      case $.CTC24:
        wapp = mctx.getWidthByApp$1(t2);
        w = !(wapp == null) && !$.eqB(amt.type, $.CTC24) ? wapp : t2.measureWidth_$1(mctx);
...
$$.RunOnceQueue = {"": ["_liblib9$_tasks>"],
 "super": "Object",
 add$3: function(key, task, timeout) {
  var t1, tid;
  t1 = this._liblib9$_tasks;
  if (!(t1 == null)) {
    tid = t1.remove$1(key);
    if (!(tid == null))
      $.window().clearTimeout$1(tid);
  } else
    this._liblib9$_tasks = $.makeLiteralMap([]);
  $.indexSet(this._liblib9$_tasks, key, $.window().setTimeout$2(new $.RunOnceQueue_add_anon(key, this, task), timeout));
},
...
$$.DragGestureState = {"": ["_gesture", "_vp", "_position", "_liblib7$_time", "eventTarget>", "startTime", "startPosition", "data"],
 "super": "GestureState",
 get$time: function() {
  return this._liblib7$_time;
},
 get$position: function() {
 ...
 snapshot$2: function(position, time) {
  ...
  this._liblib7$_time = time;
}
};

$$.DragGesture = {"": ["_move>", "_end>", "_state=", "_disabled>"],
 "super": "Gesture",
...
$$.DraggerState = {"": ["_gestureStartPosition>", "_vp", "_elementPosition", "_liblib7$_time", "eventTarget>", "dragger", "draggedElement>", "gestureState", "startTime", "elementStartPosition>", "data"],
 "super": "GestureState",
 get$time: function() {
  return this._liblib7$_time;
},
 ...
 DraggerState$_$4: function(dragger, draggedElement, targetPosition, gstate) {
  this._vp = $.VelocityProvider$(this.elementStartPosition, this.startTime);
}
};

$$.Dragger = {"": ["_start", "_move>", "_end>", "_drag", "_transform", "_disabled>", "_pending=", "_state=", "owner"],
 "super": "Gesture",
 _start$1: function(arg0) { return this._start.call$1(arg0); },
 _start$1: function(arg0) { return this._start.call$1(arg0); },
 _move$1: function(arg0) { return this._move.call$1(arg0); },
 ...
 _end$1: function(arg0) { return this._end.call$1(arg0); },
 _end$1: function(arg0) { return this._end.call$1(arg0); },
 _initState$2: function(dragged, state) {
  var tar = !(dragged == null) ? dragged.call$0() : this.owner;
  if (tar == null)
    return false;
  this._state = $.DraggerState$_(this, tar, this.getElementPosition_$1(tar), state);
  if (!(this._start == null) && this._start$1(this._state) === false) {
    this._state = null;
    this._pending = false;
    return false;
 ...
 getElementPosition_$1: function(target) {
  var off3d;
  if (this._transform === true) {
    off3d = $.CSS_offset3dOf(target.get$style().get$transform());
    return $.Offset$(off3d.get$x(), off3d.get$y());
  }
  return $.DOMAgent$(target).get$offset();
},
 setElementPosition_$2: function(target, position) {
  var t1;
  if (this._transform === true) {
    t1 = $.CSS_translate3d(position.get$left(), position.get$top(), null);
    target.get$style().set$transform(t1);
  } else {
    t1 = $.CSS_px(position.get$left());
    target.get$style().set$left(t1);
    t1 = $.CSS_px(position.get$top());
    target.get$style().set$top(t1);
  }
},
 stop$0: function() {
  var t1 = this._drag;
 ...
 Dragger$8$dragged$end$move$snap$start$threshold$transform: function(owner, dragged, end, move, snap, start, threshold, transform) {
  var t1, t2, t3;
  t1 = this.owner;
  t2 = new $.anon(this, dragged, threshold);
  t3 = new $.anon0(this, dragged, threshold, snap);
  this._drag = $.DragGesture_DragGesture(t1, new $.anon1(this), t3, t2);
}
};
...
$$.Motion = {"": ["_liblib8$_start", "_liblib8$_move>", "_liblib8$_end>", "_task", "_liblib8$_state=", "_stateFlag="],
 "super": "Object",
...
$$.ViewIterator = {"": ["_root", "_selectors", "_posOffset", "_allIds", "_offsetRoot", "_currCtx", "_ready", "_liblib4$_next=", "_index"],
 "super": "Object",
 ...
 _seekNext$0: function() {
  this._currCtx = this._index < 0 ? this._buildRootCtx$0() : this._buildNextCtx$0();
  while (true) {
...
$$.main_anon = {"": ["range_7"],
 "super": "Closure",
 call$2: function(ppos, pos) {
  return this.range_7.snap$1(pos);
}
};
...
$$.main_anon0 = {"": ["box_4"],
 ...
 call$1: function(dstate) {
  var t1, t2;
  t1 = this.box_4;
  t2 = t1.inertialMotion_5;
  if (!(t2 == null))
    t2.stop$0();
  t1 = t1.recoveryMotion_6;
  if (!(t1 == null))
    t1.stop$0();
}
};

$$.main_anon1 = {"": ["element_10", "range_9", "box_4", "deceleration_8"],
 "super": "Closure",
 call$1: function(dstate) {
  var t1, vel, initSanity, recoveryMotion, t2, inertialMotion;
  t1 = {};
  vel = dstate.get$elementVelocity();
  t1.speed_1 = vel.norm$0();
  if ($.eqB(t1.speed_1, 0)) {
    initSanity = $.sanity;
    if (typeof initSanity !== 'number')
      throw $.iae(initSanity);
    recoveryMotion = $.EasingMotion$(new $.main__anon(1 - initSanity, initSanity), new $.main__anon0(), null, 500, 1, null);
    recoveryMotion.run$0();
    this.box_4.recoveryMotion_6 = recoveryMotion;
    return;
  }
  t1.unitv_2 = $.div(vel, t1.speed_1);
  t2 = this.element_10;
  t1.pos_3 = $.DOMAgent$(t2).get$offset();
  t2 = new $.main__anon1(t1, t2, this.range_9, this.deceleration_8);
  t1 = this.box_4;
  inertialMotion = $.Motion$(new $.main__anon2(t1), t2, null);
  inertialMotion.run$0();
  t1.inertialMotion_5 = inertialMotion;
}
};

$$.main__anon = {"": ["diffSanity_12", "initSanity_11"],
 "super": "Closure",
 call$2: function(x, state) {
  $.setSanity($.add($.mul(this.diffSanity_12, x), this.initSanity_11));
}
};
...
$$.main__anon1 = {"": ["box_0", "element_15", "range_14", "deceleration_13"],
 "super": "Closure",
 call$1: function(mstate) {
  var elapsed, t1, t2, t3, t4, t5, t6;
  elapsed = mstate.get$elapsedTime();
  t1 = this.box_0;
  t1.pos_3 = $.add(t1.pos_3, $.mul($.mul(t1.unitv_2, t1.speed_1), elapsed));
  t2 = t1.pos_3.get$x();
  t3 = this.range_14;
  if ($.ltB(t2, t3.get$left()) || $.gtB(t1.pos_3.get$x(), t3.get$right())) {
    t1.unitv_2 = $.Offset$($.neg(t1.unitv_2.get$x()), t1.unitv_2.get$y());
    t1.speed_1 = $.mul(t1.speed_1, 0.8);
    $.setSanity($.mul($.sanity, 0.8));
  }
  if ($.ltB(t1.pos_3.get$y(), t3.get$top()) || $.gtB(t1.pos_3.get$y(), t3.get$bottom())) {
    t1.unitv_2 = $.Offset$(t1.unitv_2.get$x(), $.neg(t1.unitv_2.get$y()));
    t1.speed_1 = $.mul(t1.speed_1, 0.8);
    $.setSanity($.mul($.sanity, 0.8));
  }
  t1.pos_3 = t3.snap$1(t1.pos_3);
  t2 = t1.pos_3.get$left();
  t4 = $.CSS_px($.getInterceptor(t2).toInt$0(t2));
  t5 = this.element_15;
  t5.get$style().set$left(t4);
  t4 = t1.pos_3.get$top();
  t6 = $.CSS_px($.getInterceptor(t4).toInt$0(t4));
  t5.get$style().set$top(t6);
  t1.speed_1 = $.max(0, $.sub(t1.speed_1, $.mul(this.deceleration_13, elapsed)));
  return $.gt(t1.speed_1, 0);
}
};
...
$$.main__anon2 = {"": ["box_4"],
 "super": "Closure",
 call$1: function(mstate) {
  var initSanity, recoveryMotion;
  initSanity = $.sanity;
  if (typeof initSanity !== 'number')
    throw $.iae(initSanity);
  recoveryMotion = $.EasingMotion$(new $.main___anon(1 - initSanity, initSanity), new $.main___anon0(), null, 500, 1, null);
  recoveryMotion.run$0();
  this.box_4.recoveryMotion_6 = recoveryMotion;
}
};

$$.main___anon = {"": ["diffSanity_17", "initSanity_16"],
 "super": "Closure",
 call$2: function(x, state) {
  $.setSanity($.add($.mul(this.diffSanity_17, x), this.initSanity_16));
}
};
...
$$.anon = {"": ["this_4", "dragged_3", "threshold_2"],
 "super": "Closure",
 call$1: function(state) {
  var t1, t2;
  t1 = this.this_4;
  if (t1.get$_disabled() === true)
    return false;
  t1.set$_state(null);
  t1.set$_pending(false);
  t2 = $.gt(this.threshold_2, 0);
  t1.set$_pending(t2);
  if (t2 === true)
    return true;
  return t1._initState$2(this.dragged_3, state);
}
};

$$.anon0 = {"": ["this_8", "dragged_7", "threshold_6", "snap_5"],
 "super": "Closure",
 call$1: function(state) {
  var t1, t2, oldElemPos, t3;
  t1 = {};
  t2 = this.this_8;
  if (t2.get$_pending() === true && $.gtB(state.get$transition().norm$0(), this.threshold_6)) {
    t2.set$_pending(false);
    return t2._initState$2(this.dragged_7, state);
  }
  if (!(t2.get$_state() == null)) {
    oldElemPos = t2.get$_state().get$elementPosition();
    t1.elemPos_1 = $.sub($.add(t2.get$_state().get$elementStartPosition(), state.get$position()), t2.get$_state().get$_gestureStartPosition());
    t3 = this.snap_5;
    if (!(t3 == null))
      t1.elemPos_1 = t3.call$2(oldElemPos, t1.elemPos_1);
    t2.get$_state().snapshot$2(t1.elemPos_1, state.get$time());
    if (!(t2.get$_move() == null)) {
      if (t2._move$2(t2.get$_state(), new $._anon(t2, t1)) === false) {
        t2.set$_state(null);
        t2.set$_pending(false);
        return false;
      }
    } else
      t2.setElementPosition_$2(t2.get$_state().get$draggedElement(), t1.elemPos_1);
  }
}
};
...
$$._anon = {"": ["this_9", "box_0"],
 ...
 call$0: function() {
  var t1 = this.this_9;
  return t1.setElementPosition_$2(t1.get$_state().get$draggedElement(), this.box_0.elemPos_1);
}
};
...
$$.anon1 = {"": ["this_10"],
 ...
 call$1: function(state) {
  var t1 = this.this_10;
  if (!(t1.get$_state() == null) && !(t1.get$_end() == null))
    t1._end$1(t1.get$_state());
}
};
...
$$.RunOnceQueue_add_anon = {"": ["key_2", "this_1", "task_0"],
 "super": "Closure",
 call$0: function() {
  this.this_1.get$_liblib9$_tasks().remove$1(this.key_2);
  this.task_0.call$0();
}
};
...
$.createCube = function(size) {
  var v, t1, s, brow1, brow2, eye1, eye2, mouth;
  v = $.View$();
  v.set$width(size);
  v.set$height(size);
  v.get$style().set$border("2px solid #3D4C99");
  v.get$style().set$borderRadius("10px");
  t1 = $.CSS_color($.getInterceptor(92).toInt$0(92), $.getInterceptor(115).toInt$0(115), $.getInterceptor(229).toInt$0(229), null);
...
$.setSanity = function(x) {
  ...
  t3 = $.getInterceptor(t3).toInt$0(t3);
  t1 = 229 * t1;
  t3 = $.CSS_color(t2, t3, $.getInterceptor(t1).toInt$0(t1), null);
  $.cube.get$node().get$style().set$backgroundColor(t3);
  if (typeof x !== 'number')
    throw $.iae(x);
  t3 = (1 - x) * 30;
  t2 = "rotate(" + $.S($.getInterceptor(t3).toInt$0(t3)) + "deg)";
  $.brow1.get$style().set$transform(t2);
  t2 = (x - 1) * 30;
  t4 = "rotate(" + $.S($.getInterceptor(t2).toInt$0(t2)) + "deg)";
  $.brow2.get$style().set$transform(t4);
};

$.main = function() {
  var t1, mainView, box, views, t2, range, element, t3, t4;
  t1 = {};
  mainView = $.View$();
  ...
  mainView.addChild$1(box);
  views = $.createCube(100);
  if (0 >= views.length)
    throw $.ioore(0);
  $.cube = views[0];
  $.cube.set$left(250);
  ...
  if (2 >= t2)
    throw $.ioore(2);
  $.brow2 = views[2];
  mainView.addChild$1($.cube);
  range = $.Rectangle$(50, 50, 446, 446);
  element = $.cube.get$node();
  t1.inertialMotion_5 = null;
  t1.recoveryMotion_6 = null;
  t3 = new $.main_anon(range);
  t4 = new $.main_anon0(t1);
  $.Dragger$(element, null, new $.main_anon1(element, range, t1, 0.0005), null, t3, t4, -1, false);
};
...
$.StringUtil_toHexString = function(value, digits) {
  var codes, val, val0, cc, t1;
  codes = $.List_List(null);
  $.setRuntimeTypeInfo(codes, []);
  val = $.getInterceptor(value).toInt$0(value);
  if ($.ltB(val, 0)) {
    if (typeof val !== 'number')
      throw $.iae(val);
    val0 = 4294967295 + val + 1;
    val = val0;
  }
  if (val !== (val | 0))
    return $.StringUtil_toHexString$bailout(1, digits, val, codes);
  for (; val > 0;) {
    cc = val & 15;
    val = $.shr(val, 4);
    if (cc < 10) {
    ...
    $.getInterceptor(codes).insertRange$3(codes, 0, 1, cc);
  }
  val = $.sub(digits, codes.length);
  if ($.gtB(val, 0))
    $.getInterceptor(codes).insertRange$3(codes, 0, val, $.get$_CC_0());
  return $.getInterceptor(codes).get$isEmpty(codes) === true ? "0" : $.String_String$fromCharCodes(codes);
};
...
$.Futures_wait = function(futures) {
  ...
  if ($.getInterceptor(futures).get$isEmpty(futures) === true)
    return $.Future_Future$immediate($.CTC19, 'List');
...
$._domEvtTarget = function(type, node) {
  var t1, t2, t3, t4, inp;
  if ($.getInterceptor($.CTC15).contains$1($.CTC15, type) === true) {
    t1 = $.get$_inpTags();
    t2 = $.getInterceptor(t1);
    t3 = node.get$tagName();
...
$._domEventDispatcher = function(type) {
  ...
  if ($._domEvtDisps == null) {
    ...
    for (t1 = $.getInterceptor($.CTC18).iterator$0($.CTC18); t1.get$hasNext() === true;) {
      t2 = t1.next$0();
      $.indexSet($._domEvtDisps, t2, $._domEvtDisp(t2));
    }
    for (t1 = $.getInterceptor($.CTC15).iterator$0($.CTC15); t1.get$hasNext() === true;) {
      t2 = t1.next$0();
      $.indexSet($._domEvtDisps, t2, $._domEvtDisp(t2));
    }
...
$._getAmountInfo = function(view, value) {
  ...
  if ($.eqB(amt.type, $.CTC23) && view.get$layout().get$handler().get$isFlex() === true) {
    amt.type = $.CTC25;
    amt.value = 1;
  }
  return amt;
...
$.rootLayout = function(mctx, root) {
  ...
  if (!leftByApp || !topByApp) {
    ...
    if (t3)
      ...
      ref = !t1 ? $._AnchorOfNode$(cave) : $.CTC21;
    if (t3)
...
$.locateToView = function(mctx, view, location$, anchor, x, y) {
  ...
  if (!(anchor == null)) {
    ...
    $.index($._anchorXLocators(), $.index(locators, 0)).call$3($.add(x, mi.left), $.CTC29, view);
    $.index($._anchorYLocators(), $.index(locators, 1)).call$3($.add(y, mi.top), $.CTC29, view);
  }
  diff = $.add(mi.left, mi.right);
  if (!$.eqB(diff, 0))
...
$._getLocators = function(loc) {
  ...
  if ($.getInterceptor(loc).get$isEmpty(loc) === true)
    loc = "top left";
  locators = $.CTC27.operator$index$1(loc);
  if (!(locators == null))
    return locators;
  j = $.getInterceptor(loc).indexOf$1(loc, " ");
  if ($.gtB(j, 0)) {
    locators = $.CTC27.operator$index$1($.S($.getInterceptor(loc).substring$1(loc, $.add(j, 1))) + " " + $.S($.getInterceptor(loc).substring$2(loc, 0, j)));
    if (!(locators == null))
      return locators;
  }
...
$._HashSetIterator$ = function(set_, E) {
  var t1 = new $._HashSetIterator(set_._backingMap.get$_liblib0$_keys(), -1);
  $.setRuntimeTypeInfo(t1, [E]);
...
$.Section$ = function() {
  var t1 = new $.Section(null, null, null, null, null, null, null, null, null, null, null, null, null, 0, 0, null, null, null, null, false);
  t1.Section$0();
  return t1;
};
...
$.Motion$ = function(end, move, start) {
  var t1 = new $.Motion(start, move, end, null, null, 0);
  t1.Motion$3$end$move$start(end, move, start);
  return t1;
};
...
$.Dragger$ = function(owner, dragged, end, move, snap, start, threshold, transform) {
  var t1 = new $.Dragger(start, move, end, null, transform, false, false, null, owner);
  t1.Dragger$8$dragged$end$move$snap$start$threshold$transform(owner, dragged, end, move, snap, start, threshold, transform);
  return t1;
};
...
$.DraggerState$_ = function(dragger, draggedElement, targetPosition, gstate) {
  var t1, t2;
  t1 = gstate.get$eventTarget();
  t2 = gstate.get$time();
  t2 = new $.DraggerState(gstate.get$position(), null, null, null, t1, dragger, draggedElement, gstate, t2, targetPosition, null);
  t2.DraggerState$_$4(dragger, draggedElement, targetPosition, gstate);
  return t2;
};
...
$.StringUtil_toHexString$bailout = function(state0, digits, val, codes) {
  var cc;
  for (; $.gtB(val, 0);) {
    cc = $.and(val, 15);
    val = $.shr(val, 4);
    cc = $.ltB(cc, 10) ? $.add(cc, $.get$_CC_0()) : $.add(cc, $.sub($.get$_CC_a(), 10));
    $.getInterceptor(codes).insertRange$3(codes, 0, 1, cc);
  }
  val = $.sub(digits, codes.length);
  if ($.gtB(val, 0))
...
$.CTC32 = new Isolate.$isolateProperties.Returns("num|String|bool|=List|=Object|Blob|File|ArrayBuffer|ArrayBufferView");
...
$.CTC33 = Isolate.makeConstantList([1, 0]);
$.CTC34 = Isolate.makeConstantList([2, 0]);
$.CTC9 = new Isolate.$isolateProperties.ConstantMap(0, {}, Isolate.$isolateProperties.CTC19);
$.CTC35 = new Isolate.$isolateProperties.Returns("_NodeList");
$.CTC36 = new Isolate.$isolateProperties.Creates("_NodeList");
$.CTC37 = Isolate.makeConstantList([3, 0]);
$.CTC38 = new Isolate.$isolateProperties.Creates("=List");
$.CTC39 = Isolate.makeConstantList([1, 4]);
$.CTC26 = new Isolate.$isolateProperties.AmountType("ratio");
$.CTC40 = new Isolate.$isolateProperties.Creates("num|String|bool|=List|=Object|Blob|File|ArrayBuffer|ArrayBufferView");
$.CTC41 = Isolate.makeConstantList([4, 1]);
$.CTC8 = new Isolate.$isolateProperties.UIException("document not ready yet");
$.CTC11 = $.createRuntimeType('String');
$.CTC42 = Isolate.makeConstantList([0, 3]);
$.CTC28 = new Isolate.$isolateProperties.UIException("'content' not allowed in tile layout");
$.CTC22 = new Isolate.$isolateProperties.AmountType("fixed");
$.CTC43 = Isolate.makeConstantList([3, 4]);
$.CTC23 = new Isolate.$isolateProperties.AmountType("none");
$.CTC44 = Isolate.makeConstantList([2, 1]);
$.CTC25 = new Isolate.$isolateProperties.AmountType("flex");
$.CTC45 = Isolate.makeConstantList([2, 4]);
$.CTC46 = Isolate.makeConstantList([4, 3]);
$.CTC47 = Isolate.makeConstantList([0, 1]);
$.CTC48 = Isolate.makeConstantList([0, 2]);
$.CTC49 = Isolate.makeConstantList([1, 2]);
$.CTC7 = new Isolate.$isolateProperties.NullThrownError();
$.CTC50 = Isolate.makeConstantList([1, 1]);
$.CTC51 = new Isolate.$isolateProperties.Creates("MutationRecord");
$.CTC18 = Isolate.makeConstantList(["abort", "click", "dblclickdrag", "dragEnd", "dragEnter", "dragLeave", "dragOver", "dragStart", "drop", "error", "keyDown", "keyPress", "keyUp", "load", "mouseDown", "mouseMove", "mouseOut", "mouseOver", "mouseUp", "mouseWheel", "reset", "scroll", "select", "submit", "unload"]);
$.CTC52 = Isolate.makeConstantList([4, 2]);
$.CTC17 = new Isolate.$isolateProperties.UIException("listener required");
$.CTC21 = new Isolate.$isolateProperties._AnchorOfRoot();
$.CTC53 = Isolate.makeConstantList([2, 2]);
$.CTC54 = Isolate.makeConstantList([3, 2]);
$.CTC55 = Isolate.makeConstantList([3, 1]);
$.CTC24 = new Isolate.$isolateProperties.AmountType("content");
$.CTC29 = new Isolate.$isolateProperties._AnchorOfPoint();
$.CTC56 = new Isolate.$isolateProperties.Creates("IDBRequest");
$.CTC57 = new Isolate.$isolateProperties.Returns("IDBRequest");
$.CTC58 = Isolate.makeConstantList([1, 3]);
$.CTC13 = $.createRuntimeType('$int');
$.CTC59 = Isolate.makeConstantList([3, 3]);
$.CTC60 = Isolate.makeConstantList([2, 3]);
$.CTC61 = Isolate.makeConstantList(["north start", "north center", "north end", "south start", "south center", "south end", "west start", "west center", "west end", "east start", "east center", "east end", "top left", "top center", "top right", "center left", "center center", "center right", "bottom left", "bottom center", "bottom right"]);
$.CTC62 = new Isolate.$isolateProperties.Returns("=List|=Object|num|String");
$.CTC63 = new Isolate.$isolateProperties.Creates("=List|=Object|num|String");
$.CTC15 = Isolate.makeConstantList(["focus", "blur"]);
$.CTC10 = new Isolate.$isolateProperties._DeletedKeySentinel();
$.CTC64 = Isolate.makeConstantList(["body", "head", "caption", "td", "colgroup", "col", "tr", "tbody", "tfoot", "thead", "track"]);
$.CTC30 = new Isolate.$isolateProperties.ConstantMap(11, {"body": "html", "head": "html", "caption": "table", "td": "tr", "colgroup": "table", "col": "colgroup", "tr": "tbody", "tbody": "table", "tfoot": "table", "thead": "table", "track": "audio"}, Isolate.$isolateProperties.CTC64);
$.CTC31 = new Isolate.$isolateProperties.Object();
$.CTC27 = new Isolate.$isolateProperties.ConstantMap(21, {"north start": Isolate.$isolateProperties.CTC33, "north center": Isolate.$isolateProperties.CTC34, "north end": Isolate.$isolateProperties.CTC37, "south start": Isolate.$isolateProperties.CTC39, "south center": Isolate.$isolateProperties.CTC45, "south end": Isolate.$isolateProperties.CTC43, "west start": Isolate.$isolateProperties.CTC47, "west center": Isolate.$isolateProperties.CTC48, "west end": Isolate.$isolateProperties.CTC42, "east start": Isolate.$isolateProperties.CTC41, "east center": Isolate.$isolateProperties.CTC52, "east end": Isolate.$isolateProperties.CTC46, "top left": Isolate.$isolateProperties.CTC50, "top center": Isolate.$isolateProperties.CTC44, "top right": Isolate.$isolateProperties.CTC55, "center left": Isolate.$isolateProperties.CTC49, "center center": Isolate.$isolateProperties.CTC53, "center right": Isolate.$isolateProperties.CTC54, "bottom left": Isolate.$isolateProperties.CTC58, "bottom center": Isolate.$isolateProperties.CTC60, "bottom right": Isolate.$isolateProperties.CTC59}, Isolate.$isolateProperties.CTC61);
$.CTC65 = new Isolate.$isolateProperties.Creates("MutationObserver");
...
$.CTC16 = Isolate.makeConstantList(["input", "textarea", "select", "button", "a"]);
...
$.CTC66 = new Isolate.$isolateProperties.Creates("Null");
...
$._annotation_Creates_SerializedScriptValue = Isolate.$isolateProperties.CTC40;
$._annotation_Returns_SerializedScriptValue = Isolate.$isolateProperties.CTC32;
$._idbKey = "=List|=Object|num|String";
$.SimpleSelectorSequence_COMB_DESCENDANT = 0;
$._annotation_Creates_IDBKey = Isolate.$isolateProperties.CTC63;
$.SimpleSelectorSequence_COMB_GENERAL_SIBLING = 3;
$._annotation_Returns_IDBKey = Isolate.$isolateProperties.CTC62;
$.EMPTY_LIST = Isolate.$isolateProperties.CTC19;
$._anchorOfRoot = Isolate.$isolateProperties.CTC21;
$._getTypeNameOf = null;
$._locators = Isolate.$isolateProperties.CTC27;
$._$anchorXLocators = null;
$._$anchorYLocators = null;
$._HashMapImpl__DELETED_KEY = Isolate.$isolateProperties.CTC10;
...
$.AmountType_NONE = Isolate.$isolateProperties.CTC23;
$.AmountType_FIXED = Isolate.$isolateProperties.CTC22;
$.AmountType_CONTENT = Isolate.$isolateProperties.CTC24;
$.AmountType_RATIO = Isolate.$isolateProperties.CTC26;
$.AmountType_FLEX = Isolate.$isolateProperties.CTC25;
...
$._noBubEvts = Isolate.$isolateProperties.CTC15;
$._domEvtDisps = null;
...
$.$defineNativeClass('HTMLImageElement', {"": ["align>", "border<", "height=", "name=", "width=", "x>", "y>"],
...
$.$defineNativeClass('DOMWindow', {"": ["innerHeight>", "innerWidth>", "name=", "navigator>", "pageXOffset>", "pageYOffset>"],
 ...
 get$parent: function() {
  return $._convertNativeToDart_Window(this.get$_liblib3$_parent());
},
 get$_liblib3$_parent: function() {
  return this.parent;
},
...
$.$defineNativeClass('TextTrackCue', {"": ["align>", "id=", "position=", "size>"],
 get$on: function() {
...
//@ sourceMappingURL=TestAnimation3.dart.js.map